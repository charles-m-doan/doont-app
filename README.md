...
- Start the local server:
	...
	- cmd.exe:
		- `set DOONT_LOCAL_DIR=C:\\Users\\cmatt\\OneDrive\\doont && npm run local-data`
	- Git Bash:
		- `export DOONT_LOCAL_DIR="/c/Users/cmatt/OneDrive/doont"; npm run local-data`
	- Or pass the path as an argument (works in any shell):
		- `npm run local-data -- "C:\\Users\\cmatt\\OneDrive\\doont"`
